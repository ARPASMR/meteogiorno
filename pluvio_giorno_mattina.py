#!/usr/bin/env python
"""
Crea mappe pluvio_giorno ad uso del bollettino meteogiorno: plot cumulate della mattina 
...
def pluvio_graf():
    ...
    plt.savefig("pluvio_giorno_" + ieri + "_mattina.png", format='png', bbox_inches='tight') #eseguo e salvo il grafico
