#!/usr/bin/env python
"""
Crea mappe pluvio_giorno ad uso del bollettino meteogiorno: plot cumulate del pomeriggio 
precedente interrogando IRIS per i confini regionali e DBmeteo per i dati da pluviometro

Created on 25/7/2025
@author: mranci, ebrambilla
"""
...
def pluvio_graf():
    ...
    plt.savefig("pluvio_giorno_" + ieri + "_pomeriggio.png", format='png', bbox_inches='tight') #eseguo e salvo il grafico
